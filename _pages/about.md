...
My research area is machine learning, mainly focusing its basic methods and theory. About ten years ago, I started to investigate how to train large models fast with distributed optimization algorithms, then how to improve the performance of deep learning by understanding its optimization and generalization, and now how to make machine learning safe and trustworthy. My current research interests are causal machine learning and deep learning theory, such as causality-inspried models and o.o.d. prediction, the implicit regularization of the optimization algorithms in deep learning, robust learning and its applications in NLP and CV, etc. 
